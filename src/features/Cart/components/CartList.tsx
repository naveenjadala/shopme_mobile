 ...
 * @prop {function} productDetails - A function that takes the product id as an argument
 * and navigates to the product details screen.
...
const CartList = ({ productDetails, cateData }: CartListProps) => {
  ...
  const { subtotal, total } = React.useMemo(() => {
    ...
    return {
      ...
      deliveryFee: rawDeliveryFee.toFixed(2),
      total: (rawSubtotal + rawDeliveryFee).toFixed(2),
    };
