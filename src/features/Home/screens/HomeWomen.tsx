...
/**
 * HomeWomen is a component that displays a list of featured products, categories
...
const HomeWomen = () => {
  ...
  const { data: latestDropsData } = useGetLatestProductsQuery({
    categoryFilter,
  });
  ...
  return (
    <ScrollView>
      ...
      <LatestDrops
        ...
        goToProducts={() => reDirectToProduct({ isLatest: true, gender: 'women' })}
      />
    </ScrollView>
  );
};
